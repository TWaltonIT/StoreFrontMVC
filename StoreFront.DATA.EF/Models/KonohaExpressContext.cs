...
{
    public partial class KonohaExpressContext : DbContext
    {
        public KonohaExpressContext()
        {
        }

        public KonohaExpressContext(DbContextOptions<KonohaExpressContext> options)
            : base(options)
        {
        }
        ...
        public virtual DbSet<ChakraNature> ChakraNatures { get; set; } = null!;
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see http://go.microsoft.com/fwlink/?LinkId=723263.
                optionsBuilder.UseSqlServer("Server=.\\sqlexpress;Database=KonohaExpress;Trusted_Connection=true;Encrypt=false;MultipleActiveResultSets=true;");
            }
        }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<ChakraNature>(entity =>
            {
                entity.HasKey(e => e.NatureId);

                entity.ToTable("ChakraNature");

                entity.Property(e => e.NatureId).HasColumnName("NatureID");

                entity.Property(e => e.NatureDescription).IsUnicode(false);
            ...
            modelBuilder.Entity<Order>(entity =>
            {
                ...
                entity.Property(e => e.ShipVillage)
                    .HasMaxLength(150)
                    .IsUnicode(false);
            ...
            modelBuilder.Entity<Product>(entity =>
            {
                ...
                entity.HasOne(d => d.Nature)
                    ...
                    .HasConstraintName("FK_Products_ChakraNature");
            ...
            modelBuilder.Entity<Shipper>(entity =>
            {
                ...
                entity.Property(e => e.ShipperVillage)
                    .HasMaxLength(150)
                    .IsUnicode(false);
            });
            ...
            modelBuilder.Entity<Supplier>(entity =>
            {
                ...
                entity.Property(e => e.SupplierVillage)
                    .HasMaxLength(150)
                    .IsUnicode(false);
            });
